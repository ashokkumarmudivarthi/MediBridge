    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .authorizeHttpRequests(auth -> {
                ...
                auth.requestMatchers("/api/auth/login","/api/doctors/list").permitAll();
                ...
                auth.requestMatchers("/api/doctors/**","/api/doctors/list","/api/**","/api/doctors/my-profile").hasAnyAuthority("ROLE_DOCTOR", "ROLE_ADMIN");
