...
const DOCTOR_SERVICE_URL = process.env.REACT_APP_DOCTOR_SERVICE || "http://localhost:8084"; // ✅ Add doctor service
...
const DoctorDashboardPage = () => {
  ...
  const [doctorProfile, setDoctorProfile] = useState(null); // ✅ New
  ...
  const fetchDoctorProfile = useCallback(async () => {
    try {
      ...
      if (res.ok) {
        ...
        setDoctorId(data.id); // ✅ Set doctorId for appointment fetch
