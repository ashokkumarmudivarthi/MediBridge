  ...
  return (
    <>
      ...
      <header className="bg-primary text-white text-center py-3 mb-4">
        <h2>🏥 Patient List - WellnessWave Healthcare</h2>
      </header>
      ...
      <div className="container">
        <form onSubmit={applyFilters} className="row g-2 mb-3">
          ...
          {/*Disabled disease filter as per request
          ...
          */}
          ...
          <div className="col-md-3 d-flex gap-2">
            ...
            <button type="button" className="btn btn-secondary w-100" onClick={clearFilters}>❌ Clear</button>
          </div>
        </form>

        {/* Action Buttons */}
        <div className="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
          <button className="btn btn-outline-primary" onClick={() => navigate("/admin/patients")}>
            🏠 Back to Home
          </button>
          <div className="d-flex gap-2">
            <button className="btn btn-outline-danger" onClick={exportToPDF}>📄 Export PDF</button>
            <button className="btn btn-outline-success" onClick={exportToCSV}>📊 Export Excel</button>
          </div>
        </div>
                ...
                pageData.map((patient, index) => (
                  ...
                  >
                    ...
                    <td>
                      <button
                        className="btn btn-sm"
                        style={{ backgroundColor: "#FF2400", color: "#fff", border: "none" }}
                        onClick={() => deletePatient(patient.id)}
                      >
                        🗑️ Delete
                      </button>
