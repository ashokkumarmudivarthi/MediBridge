...
const DashboardPage = () => {
  ...
  const [userId, setUserId] = useState(null); // ✅ to hold logged-in user ID
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      try {
        ...
        setUserId(data.id || null); // ✅ set userId here
  ...
  // ✅ Modules array now uses userId properly with template literal
  const modules = [
    {
      icon: "fa-user-plus",
