  ...
  return (
    <>
      ...
      <header className="bg-info text-white text-center py-4">
        ...
        <p>Admin access to all doctor-related operations</p>
      </header>
        ...
        <div className="row justify-content-center">
          <div className="col-md-4 mb-4">
            <div className="card shadow p-3 h-100 text-center">
              ...
              <h5 className="mt-3">Register Doctor</h5>
              <p>Add new doctor details to the system.</p>
              <button
          ...
          <div className="col-md-4 mb-4">
            <div className="card shadow p-3 h-100 text-center">
              <i className="fas fa-list-alt fa-2x text-primary"></i>
              <h5 className="mt-3">View Doctors</h5>
              <p>List all registered doctors and their specialties.</p>
              <button
                className="btn btn-primary"
                onClick={() => navigate("/doctorsviewlist")}
              >
                View List
              </button>
            </div>
