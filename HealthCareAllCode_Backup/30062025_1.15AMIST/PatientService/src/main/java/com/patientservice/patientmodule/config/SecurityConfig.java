    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/auth/**").permitAll()
               // .requestMatchers("/api/documents/upload","/api/documents/download/**","/api/documents/by-patient/**").hasAnyAuthority("ROLE_ADMIN","ROLE_DOCTOR","ROLE_PATIENT")

                .requestMatchers(
                	    "/api/documents/upload",
                	    "/api/documents/download/**",
                	    "/api/documents/by-patient/**",
                	    "/api/documents/by-visit/**"
                ...
                .requestMatchers("/api/patients/list-json", "/api/patients/count","/api/patients/names")
                    .hasAnyAuthority("ROLE_ADMIN", "ROLE_DOCTOR")

                .requestMatchers("/api/patient-visits/create", "/api/patient-visits/patient/**")
                    .hasAnyAuthority("ROLE_ADMIN", "ROLE_DOCTOR","ROLE_PATIENT")
                    .requestMatchers("/api/patient-visits/patient/**")
                    .hasAnyAuthority("ROLE_ADMIN", "ROLE_DOCTOR", "ROLE_PATIENT")
