...
const DashboardPage = () => {
  ...
  actions: [
    ...
    { label: "Delete Patient", path: "/delete-patient", style: "danger", method: "GET", type: "redirect" },
    { label: "Search Patient", path: "/search-patient", style: "info", method: "GET", type: "redirect" },
  ],
},

    {
      ...
      actions: [
        { label: "Schedule Appointment", path: "/schedule-appointment", style: "success", method: "GET", type: "redirect" },
        { label: "View Appointments", path: "/appointments-list", style: "primary", method: "GET", type: "redirect" },
      ],
    },
    {
      icon: "fa-user-md",
      ...
      actions: [
        { label: "Add Doctor", path: "/add-doctor", style: "success", method: "GET", type: "redirect" },
        { label: "View Doctors", path: "/doctorsviewlist", style: "primary", method: "GET", type: "redirect" },
         { label: "Delete Doctor", path: "/delete-doctor", style: "danger", method: "GET", type: "redirect" },
    { label: "Search Doctor", path: "/search-doctor", style: "info", method: "GET", type: "redirect" },
      ],
    },
    {
      icon: "fa-file-medical",
      ...
      desc: "Access and update patient medical history.",
      actions: [
        { label: "Add Medical Record", path: "/admin/medical-records/new", style: "success", method: "GET", type: "redirect" },
       
         
    { label: "Search Records", path: "/medical-records", style: "info", method: "GET", type: "redirect" },
...
const DashboardPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      try {
        const res = await fetch(`${AUTH_SERVICE_URL}/auth/dashboard`, {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
          },
  ...
  return (
    <>
      ...
      <div className="container my-5">
        ...
        // Only Show Patient Management Link
        <div className="row mt-4">
          <div className="col-md-4">
            <div className="card shadow p-3 h-100 text-center">
              <i className="fas fa-user-plus fa-2x text-success"></i>
              <h4 className="mt-3">Patient Management</h4>
              <p>Manage all patient operations</p>
              <button
