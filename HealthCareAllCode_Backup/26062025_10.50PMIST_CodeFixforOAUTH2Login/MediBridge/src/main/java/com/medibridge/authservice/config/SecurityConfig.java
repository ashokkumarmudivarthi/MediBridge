...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
                                           ObjectProvider<CustomOAuth2SuccessHandler> successHandlerProvider) throws Exception {

        CustomOAuth2SuccessHandler customOAuth2SuccessHandler = successHandlerProvider.getIfAvailable();
        ...
        http
            ...
            .oauth2Login(oauth -> oauth
                .loginPage("/login") // A neutral login page
                .defaultSuccessUrl("/auth/login-success", true)
                .failureUrl("/login?error=true")
                .successHandler(customOAuth2SuccessHandler)
            )
