...
const APPOINTMENT_SERVICE_URL = process.env.REACT_APP_APPOINTMENT_SERVICE;
const MEDICAL_RECORD_SERVICE_URL = process.env.REACT_APP_MEDICAL_RECORD_SERVICE;
//const VISIT_SERVICE_URL = process.env.REACT_APP_VISIT_SERVICE;
const AUTH_SERVICE_URL = process.env.REACT_APP_AUTH_SERVICE;
        ...
        <div className="row g-4">
          ...
          <div className="col-md-6">
            <div className="card shadow-sm">
                  ...
                  <ul className="list-group">
                    {visitRecords.map((v, i) => (
                      <li key={i} className="list-group-item">
                        ...
                        <strong>Admition Date:</strong> {v.admissionDate ? new Date(v.admissionDate).toLocaleDateString() : 'N/A'}<br />
                        <strong>Discharge Date:</strong> {v.dischargeDate ? new Date(v.dischargeDate).toLocaleDateString() : 'N/A'}
                      </li>
                    ))}
                  </ul>
                )}
              ...
              <div className="card-footer d-flex justify-content-between">
                <button className="btn btn-outline-dark btn-sm" onClick={() => navigate("/inpatient-details")}>In-Patient Details</button>
                <button className="btn btn-outline-dark btn-sm" onClick={() => navigate("/outpatient-details")}>Out-Patient Details</button>
              </div>
            </div>
          </div>
