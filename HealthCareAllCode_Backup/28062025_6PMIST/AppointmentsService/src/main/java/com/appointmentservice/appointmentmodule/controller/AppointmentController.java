...
public class AppointmentController {
    ...
    public ResponseEntity<ApiResponse<Appointment>> publicSchedule(@RequestBody Appointment appointment) {
        Appointment saved = service.scheduleAppointment(appointment);
        return ResponseEntity.ok(new ApiResponse<>(true, "Appointment submitted successfully!", saved));
    }
